...
git config --global user.email “realdavidturnbull@gmail.com”
...
mas signin realdavidturnbull@gmail.com
...
# mas signin realdavidturnbull@gmail.com # Include password to automate completely
# mas upgrade
# brew upgrade
# brew cleanup --force
# brew cask upgrade
